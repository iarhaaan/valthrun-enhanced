...
impl Enhancement for SpectatorsListIndicator {
    ...
    fn render(
        ...
        let spectator_count = spectators.spectators.len();
        ...
        let line_count = spectator_count + 1;
        ...
        ui.unicode_text_with_shadow(unicode_text, &format!("Spectators ({}):", spectator_count));
